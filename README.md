...
- game:
      ...
      It has been mathematically proven that 17 is the lowest you can go
- test:
      ...
      EndtoEndTest could be further improve to be more thorough in the checking of the program's outputs
